...
gym.register(
    id="Lerobot-So101-Controller-Cube-Box",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.cube_box_env_cfg:SO101CubeBoxTeleopEnvCfg",
    },
)
...
_CLOTH_TASK_CONFIGS = {
    ...
    "SO101-Cloth-Edge-Drag-v0": "SO101ClothEdgeDragEnvCfg",
    "SO101-Cloth-Corner-Fold-v0": "SO101ClothCornerFoldEnvCfg",
    "SO101-Cloth-Obstacle-Drape-Pull-v0": "SO101ClothObstacleDrapePullEnvCfg",
}

for _task_id, _config_name in _CLOTH_TASK_CONFIGS.items():
    gym.register(
        id=_task_id,
        entry_point="isaaclab.envs:ManagerBasedRLEnv",
        disable_env_checker=True,
        kwargs={"env_cfg_entry_point": f"{__name__}.cloth_env_cfg:{_config_name}"},
    )
