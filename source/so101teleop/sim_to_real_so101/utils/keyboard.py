...
class KeyboardControl:
    ...
    def __init__(self, reset_recording_policy: str = "stop"):
        if reset_recording_policy not in {"stop", "cancel"}:
            raise ValueError("reset_recording_policy must be 'stop' or 'cancel'")
        self.reset_recording_policy = reset_recording_policy
    ...
    def _on_keyboard_event(self, event, *args, **kwargs):
        ...
        if event.type == carb.input.KeyboardEventType.KEY_PRESS:
            if event.input.name == "R":
                ...
                if self.reset_recording_policy == "cancel":
